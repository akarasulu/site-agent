...
| Generated surfaces | MCP, Python API, local API bridge, Ansible collection, OpenAPI/Postman docs, MCP import, contract diff, adapter refresh commands, and MCP-build Python API synchronization exist. |
...
* OpenAPI 3.1, Postman collection, Postman environment, and API reference docs
  are generated from the approved tools/API spec.
...
* Embed generated API docs into the explorer as the default consumer-facing
  view.
