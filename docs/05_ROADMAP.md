...
| Generated surfaces | MCP, Python API, Ansible collection, OpenAPI/Postman docs, MCP import, contract diff, adapter refresh commands, and MCP-build Python API synchronization exist. |
