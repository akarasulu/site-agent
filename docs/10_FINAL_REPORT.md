...
research-backed implementation and documentation refresh through `v1.16.0`.
...
| Explorer portal | Generated explorers default to role-based Use, Automate, Audit, and Debug modes with selected-operation examples, Swagger operation links, native dry-run Try execution, and dense evidence collapsed by default. |
...
| Local API bridge | `site-agent api serve` exposes generated methods through local HTTP for Swagger UI, explorer Try panel, and Postman execution. |
...
generated documentation, package docs/Postman publishing, script syntax,
generated JavaScript, and rendered splitter smoke validation.
...
implementation planning, and release-gate review at `v1.16.0`. Before a public
