...
| Package metadata version | `1.14.1` in `pyproject.toml` |
| Runtime package version | `1.14.1` in `site_agent/__init__.py` |
...
Checkpoint `v1.14.1` renders browser-facing artifacts and collapses dense
